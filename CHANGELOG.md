...
- Refactored the NutritionGuideline persistence model for issue [#76](../../issues/76) to use application-owned objective, context, strategy, and guidance fields while keeping Notion extraction unchanged.
