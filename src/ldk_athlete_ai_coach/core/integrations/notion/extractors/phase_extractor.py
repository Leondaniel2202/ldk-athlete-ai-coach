...
def extract_phase(raw_page: dict[str, Any]) -> NotionPhase:
    ...
    try:
        ...
        return NotionPhase(
            ...
            phase_type=get_select(props.get("Phase Type", {})),
            focus_tags=get_multi_select(props.get("Focus Tags", {})),
            weekly_structure=get_rich_text(props.get("Weekly Structure", {})),
            timeframe_start=timeframe_start,
            timeframe_end=timeframe_end,
            timeframe_is_datetime=timeframe_is_datetime,
            plan_notion_id=get_first_relation(props.get("Plan", {})),
            nutrition_guideline_notion_id=get_first_relation(props.get("Nutrition Guideline", {})),
